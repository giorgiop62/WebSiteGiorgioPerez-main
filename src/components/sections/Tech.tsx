...
const techs = [
  ...
  { name: "GitHub", svg: <path d="M12 2a10 10 0 00-3.2 19.5c.5.1.7-.2.7-.5v-1.9c-2.9.6-3.5-1.2-3.5-1.2-.5-1.2-1.1-1.5-1.1-1.5-.9-.6.1-.6.1-.6 1 .1 1.6 1.1 1.6 1.1.9 1.6 2.5 1.1 3 .8.1-.7.4-1.1.7-1.3-2.3-.3-4.7-1.2-4.7-5A3.9 3.9 0 016.6 7.7c-.1-.3-.5-1.3.1-2.7 0 0 .9-.3 2.8 1.1a9.7 9.7 0 015 0c1.9-1.4 2.8-1.1 2.8-1.1.6 1.4.2 2.4.1 2.7a3.9 3.9 0 011.1 2.7c0 3.9-2.4 4.7-4.7 5 .4.3.8 1 .8 2v3.6c0 .3.2.6.8.5A10 10 0 0012 2z" /> },
  { name: "Postman", svg: <><circle cx="12" cy="12" r="10" /><path fill="hsl(var(--background))" d="M16.8 7.2l-7.6 7.6-2 .4.4-2 7.6-7.6 1.6 1.6zm-5.6 5.2l1.4 1.4 4.8-4.8L16 7.6l-4.8 4.8zm-1.8 2.2l.9-.2-.7-.7-.2.9z" /></> },
  { name: "MySQL", svg: <><ellipse cx="12" cy="6" rx="8" ry="3" /><path d="M4 6v6c0 1.7 3.6 3 8 3s8-1.3 8-3V6c0 1.7-3.6 3-8 3S4 7.7 4 6zm0 6v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6c0 1.7-3.6 3-8 3s-8-1.3-8-3z" /><path fill="hsl(var(--background))" d="M7.5 6c0-.7 2-1.4 4.5-1.4s4.5.7 4.5 1.4-2 1.4-4.5 1.4S7.5 6.7 7.5 6z" /></> },
];
